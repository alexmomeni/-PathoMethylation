...
class Config(object):
    ...
    def __init__(self, source="GBM", folder="test", models="Logistic Regression", classifier="rf", test_size=0.25, clustering= "hierarchical", n_clusters=5, n_tasks=1147):
        ...
        ax1.plot([0, 1], [0, 1], linestyle='--', lw=2, color='black', label='Luck', alpha=.8)
